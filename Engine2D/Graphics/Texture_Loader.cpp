...
extern "C"
{
	...
	{
		if (Graphics::_Event::EventisInited == nullptr || (Graphics::_Event::EventisInited != nullptr && !Graphics::_Event::EventisInited()))
		{
			std::cerr << Graphics::_Event::EventisInited << std::endl;
